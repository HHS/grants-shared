...
This repository contains common functionality that is used by:
...
[CONTRIBUTING.md](CONTRIBUTING.md) to learn more.
...
- [Architecture Decision Records](./documentation/architecture/README.md)
...
A full list of [contributors](https://github.com/HHS/grants-shared/graphs/contributors) can be found on GitHub.
