...
INVALID_INTEGER = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid integer.")
...
INVALID_STRING = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid string.")
INVALID_STRING_PATTERN = MarshmallowErrorContainer(
    SchemaValidationError.FORMAT, "String does not match expected pattern."
)
INVALID_DATE = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid date.")
INVALID_DATETIME = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid datetime.")
INVALID_TIME = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid time.")
INVALID_URL = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid URL.")
INVALID_FLOAT = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid number.")
...
INVALID_BOOLEAN = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid boolean.")
INVALID_SCHEMA_MSG = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Invalid input type.")
INVALID_SCHEMA = {"_schema": [INVALID_SCHEMA_MSG]}
INVALID_LIST = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid list.")
INVALID_UUID = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid UUID.")
INVALID_DECIMAL = MarshmallowErrorContainer(SchemaValidationError.INVALID, "Not a valid decimal.")
...
class FieldTestSchema(Schema):
    ...
    field_str_one_of = fields.String(validate=[validators.OneOf(["a", "b"])])
...
def get_valid_field_test_schema_req():
    return {
        ...
        "field_int_min": 25,
        "field_int_max": 40,
        "field_int_min_max": 50,
        "field_int_min_max_with_32bit": 5,
        "field_bool": True,
...
def get_invalid_field_test_schema_req():
    return {
        ...
        "field_int_min": 1,
        "field_int_max": 255,
        "field_int_min_max": 100,
        "field_int_min_max_with_32bit": 55,
        "field_bool": 1234,
